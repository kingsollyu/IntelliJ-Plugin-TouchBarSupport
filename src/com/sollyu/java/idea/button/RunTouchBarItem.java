...
public class RunTouchBarItem extends AbstractTouchBarItem implements Runnable {
    public RunTouchBarItem() {
        super("Run");
    }
    ...
    @Override
    public void run() {
        ActionManager.getInstance().getAction("Run").actionPerformed(

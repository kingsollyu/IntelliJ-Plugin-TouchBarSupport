 ...
 * @author sollyu
 */
public class SurroundWithTouchBarItem extends AbstractTouchBarItem implements Runnable {
    public SurroundWithTouchBarItem() {
        super("SurroundWith");
    }
    ...
    @Override
    public void run() {
        ActionManager.getInstance().getAction("SurroundWith").actionPerformed(

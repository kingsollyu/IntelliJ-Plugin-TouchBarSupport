 ...
 * @author sollyu
 */
public class ReformatCodeTouchBarItem extends AbstractTouchBarItem implements Runnable {
    public ReformatCodeTouchBarItem() {
        super("ReformatCode");
    }
    ...
    @Override
    public void run() {
        ActionManager.getInstance().getAction("ReformatCode").actionPerformed(

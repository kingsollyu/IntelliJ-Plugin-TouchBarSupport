 ...
 * @author sollyu
 */
public class RenameTouchBarItem extends AbstractTouchBarItem implements Runnable {
    public RenameTouchBarItem() {
        super("Rename");
    }
    ...
    @Override
    public void run() {
        ActionManager.getInstance().getAction("RenameElement").actionPerformed(
